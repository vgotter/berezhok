...
WELCOME_TEXT = (
    ...
    "🔗 Пришли мне ссылку — если сайт доступен без региональных ограничений, "
    "я постараюсь найти название, цену и фотографию. Ты всё проверишь прямо "
    "в чате.\n"
...
def draft_text(row):
    if row["name"].startswith("Вещь с "):
        return (
            "Ссылка сохранена, но сайт не отдал мне данные карточки. Возможно, "
            "он использует региональные ограничения. Название и цену можно "
            "быстро указать кнопкой ниже."
        )
    if row["price"]:
