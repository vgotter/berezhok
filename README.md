...
Open Graph и Schema.org название, цену и фотографию. Бот покажет черновик прямо
в чате: название и цену можно изменить кнопками, а после подтверждения вещь
